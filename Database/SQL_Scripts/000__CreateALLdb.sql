...
INSERT INTO City(name, established, averageTemp) VALUES
    ('Paris', '0520-01-01', 12.3),
    ('London', '0043-01-01', 11.7),
    ('Rome', '0753-04-21', 15.5),
    ('Berlin', '1237-01-01', 9.9),
    ('Madrid', '0856-01-01', 14.5),
    ('Vienna', '0500-01-01', 10.8),
    ('Lisbon', '1147-01-01', 16.2),
    ('Amsterdam', '1275-10-27', 10.5),
    ('Prague', '0935-01-01', 9.0),
    ('Barcelona', '0150-01-01', 16.5),
    ('Hamburg', '0800-01-01', 9.5),
    ('Luxembourg', '0963-01-01', 10.2);
/* ---------------------------------------------------------- */
/* ---------------------------------------------------------- */
/* -------------------------- END --------------------------- */
/* ---------------------------------------------------------- */
